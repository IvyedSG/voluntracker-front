            ...
            <ul class="space-y-5">
              <li v-for="(item, index) in navigation" :key="index">
                ...
                >
                  ...
                  <span class="text-[10px] font-medium tracking-wide leading-tight text-center">
                    {{ item.name }}
                  </span>
                </NuxtLink>
              </li>
        ...
        <div class="mt-auto flex flex-col items-center space-y-4 mb-5">
          ...
          <UDropdownMenu :items="userMenuItems" :popper="{ placement: 'right-start' }">
            <div class="cursor-pointer flex flex-col items-center group">
              ...
              <span class="text-[10px] font-medium text-green-100/90 mt-1 group-hover:text-green-300 transition-colors duration-200">
                {{ user?.nombre || 'Tenant' }}
              </span>
            </div>
          </UDropdownMenu>
