      ...
      >
        <div class="p-5">
          <div class="flex items-center mb-6">
            <div
              class="w-12 h-12 rounded-full bg-indigo-900/30 flex items-center justify-center mr-4"
            >
              <UIcon
          ...
          <div class="space-y-6">
            ...
            >
              <div class="flex items-center">
                ...
                <UBadge
                  ...
                  :variant="
                    coordinador.estado === 'activo' ? 'solid' : 'subtle'
                  "
                  size="sm"
                  class="ml-auto"
                >
            ...
            <div class="space-y-4">
              <div
                class="bg-indigo-900/20 border border-indigo-800/30 rounded-lg p-4"
              >
                <div class="flex">
                  <UIcon
                    name="i-heroicons-information-circle"
                    class="h-5 w-5 text-indigo-400 mr-2 flex-shrink-0 mt-0.5"
                  />
                  <div class="text-sm text-indigo-300">
                    <p>
                      Se enviará una invitación por correo electrónico a
                      <strong>{{ coordinador.correo }}</strong> con
                      instrucciones para acceder a la plataforma.
                    </p>
                    <p v-if="coordinador.estado === 'pendiente'" class="mt-1.5">
                      Este coordinador aún no ha activado su cuenta. Al enviar
                      la invitación, tendrá 7 días para completar el registro.
                    </p>
                    <p
                      v-else-if="coordinador.estado === 'inactivo'"
                      class="mt-1.5"
                    >
                      Este coordinador está actualmente inactivo. Al enviar la
                      invitación, su estado cambiará a pendiente y tendrá acceso
                      limitado hasta activación.
                    </p>
                    <p v-else class="mt-1.5">
                      Este coordinador ya tiene acceso activo a la plataforma.
                      Esta acción enviará un recordatorio con sus credenciales.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <UFormGroup label="Mensaje personalizado (opcional)">
                ...
                <template #description>
                  <p class="text-gray-400 text-xs">
                    Este mensaje personalizado aparecerá en el correo junto con
...
function getEstadoColor(estado) {
  switch (estado) {
    case "activo":
      return "green"; // ❌ Era 'success'
    case "inactivo":
      return "yellow"; // ❌ Era 'warning'
    case "pendiente":
      return "blue";
    default:
      return "gray";
