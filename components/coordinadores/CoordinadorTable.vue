  ...
  <UCard class="shadow-lg border border-gray-700/50 overflow-hidden">
    <div class="flex justify-between items-center mb-4">
      <div class="flex items-center">
        <div
          class="w-8 h-8 flex items-center justify-center rounded-full bg-blue-900/40 mr-3"
        >
      ...
      <div
        class="flex items-center bg-blue-900/20 px-3 py-1.5 rounded-full text-sm text-blue-300 font-medium"
      >
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm text-left text-gray-300">
        <thead>
          <tr
            class="text-gray-400 uppercase bg-gray-800/40 border-b border-gray-700"
          >
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3">
              <div class="flex items-center">
                <div
                  class="w-6 h-6 rounded-full bg-blue-900/30 flex items-center justify-center mr-2"
                >
            ...
            <td class="px-4 py-3">
              <div class="flex flex-wrap gap-1.5">
                <UBadge
                  v-for="(area, idx) in c.areasAsignadas"
                  :key="idx"
                  color="info"
                  variant="outline"
                  size="xs"
            ...
            <td class="px-4 py-3">
              <UBadge
                :color="c.nivelAcceso === 'avanzado' ? 'primary' : 'info'"
                variant="subtle"
                size="md"
                :icon="
                  c.nivelAcceso === 'avanzado'
                    ? 'i-heroicons-star'
            ...
            <td class="px-4 py-3">
              <div class="flex items-center">
                <div
                  class="w-6 h-6 rounded-full bg-amber-900/30 flex items-center justify-center mr-2"
                >
            ...
            <td class="px-4 py-3">
              <div
                class="flex gap-2 justify-center bg-gray-800/50 rounded-lg p-1"
              >
          ...
          <tr v-if="coordinadores.length === 0">
            <td colspan="8" class="px-4 py-10 text-center">
              <div class="flex flex-col items-center justify-center">
                <div
                  class="w-16 h-16 rounded-full bg-gray-800/50 flex items-center justify-center mb-3"
                >
                  <UIcon
                ...
                <p class="text-gray-400 mt-1">
                  Agrega coordinadores para verlos listados aquí
                </p>
                <UButton
                  class="mt-4"
                  color="success"
...
function getEstadoColor(estado: string): string {
  switch (estado) {
    case "activo":
      return "success"; // ❌ Era "success"
    case "inactivo":
      return "warning"; // ❌ Era "warning"
    case "pendiente":
      return "info"; // ❌ Era "info"
    default:
      return "neutral"; // ❌ Era "neutral"
  }
}
